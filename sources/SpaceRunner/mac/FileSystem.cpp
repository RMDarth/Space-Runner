...
{
	std::string file = Ogre::macBundlePath() + "/Contents/Resources/" + filename;
...
{
	string file = Ogre::macBundlePath() + "/Contents/Resources/" + filename;
...
{
	opened = false;
	filename = Ogre::macBundlePath() + "/Contents/Resources/" + filename;
